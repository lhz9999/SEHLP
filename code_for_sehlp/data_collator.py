...
class DataCollatorForSeq2Seq:
    ...
    def __call__(self, cur_dataset, return_tensors=None):
        ...
        summary_features = list()        # summary 表示
        for single_data in cur_dataset:
            features.append(single_data["full_prompt"])
            summary_features.append(single_data["summary"])
        ...
        summary_features = self.robertaTokenizer.pad(
            summary_features,
            padding=self.padding,
        ...
        res_data = {"full_prompt": features, "labels": features["labels"], "summary": summary_features}
        return res_data
